...
| MenuScene | [`js/scenes/MenuScene.js`](js/scenes/MenuScene.js) | Full screen | Title **Sweet Adventure**. Subtitle **Pick a match**. Player name in the corner. Buttons: LOGIN, REGISTER, LOGOUT, INVENTORY (stub), START GAME, UI TESTS, EXIT (stub). |
...
| TestsScene | [`js/scenes/TestsScene.js`](js/scenes/TestsScene.js) | Full screen | Title **Tests**. Subtitle **Pick a sandbox**. Buttons: UI PLAZMA BALL, HOT MAP BALL, BACK. |
