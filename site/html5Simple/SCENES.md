...
| TestsScene | [`js/scenes/TestsScene.js`](js/scenes/TestsScene.js) | Full screen, **780×844** (2× game width) | Title **Tests**. Subtitle **Pick a sandbox**. Buttons in two columns: left UI EDITOR, COMPOSITE UI EDITOR, UI PLAZMA BALL, HOT MAP BALL, ROTATED HOT MAP BALL; right MOVE HOT ROD, BACK HIGHLIGHT, SHARD, MOVE HOT CIRCLE, BACK. Entering this hub widens the Phaser canvas; child sandboxes use that width. BACK to Menu restores **390×844**. |
