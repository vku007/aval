...
| TestsScene | [`js/scenes/TestsScene.js`](js/scenes/TestsScene.js) | Full screen, **780×844** (2× game width) | Title **Tests**. Subtitle **Pick a sandbox**. Buttons: UI EDITOR, UI PLAZMA BALL, HOT MAP BALL, ROTATED HOT MAP BALL, MOVE HOT ROD, BACK HIGHLIGHT, MOVE HOT CIRCLE, BACK. Entering this hub widens the Phaser canvas; child sandboxes use that width. BACK to Menu restores **390×844**. |
