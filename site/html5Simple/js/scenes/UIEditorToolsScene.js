/**
 * UIEditorToolsScene
 * Second canvas: effects, props, and the object list.
 * The stage stays on the main game canvas.
 */
class UIEditorToolsScene extends Phaser.Scene {
    constructor() {
        super({ key: 'UIEditorToolsScene' });
    }
    ...
    create() {
        ...
        this.add.text(colX + 12, 18, 'UI Editor', {
    ...
    onSaveClick() {
        try {
            const bytes = saveUiEditorPresetFile(serializeUiEditor(this.heatMap, this.balls, this.rods, this.highlighters));
